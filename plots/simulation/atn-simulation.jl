...
tau_inits[tau_seed_idx] .+= 0.1 .* ((part[tau_seed_idx] .+ β .* (ui[tau_seed_idx] - u0[tau_seed_idx])) .- v0[tau_seed_idx])
...
testdf = DataFrame(fbb_ui = LinRange(0.0, 1.5, 100),
                   fbp_ui = LinRange(0.0, 1.5, 100),
                   fmm_ui = LinRange(0.0, 1.5 ,100))
