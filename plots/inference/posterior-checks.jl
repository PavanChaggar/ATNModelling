...
begin
    ...
    ax = Axis(g[1][1,1], xticks=0:0.1:0.5,   xlabel=L"1 / yr", xlabelsize=25,ylabel=L"\alpha", ylabelrotation=2pi, ylabelsize=50, ylabelpadding=20)
    hidespines!(ax, :l, :t, :r)
    ...
    ax = Axis(g[2][1,1], xticks=0:0.03:0.15,  xlabel=L"1 / yr", xlabelsize=25,ylabel=L"\rho", ylabelrotation=2pi, ylabelsize=50, ylabelpadding=20)
    hidespines!(ax, :l, :t, :r)
    hideydecorations!(ax, label=false)
    xlims!(ax, 0.0,0.15)
    ...
    ax = Axis(g[3][1,1],  xticks=0:0.03:0.15,  xlabel=L"1 / yr", xlabelsize=25,ylabel=L"\gamma", ylabelrotation=2pi, ylabelsize=50, ylabelpadding=20)
    hidespines!(ax, :l, :t, :r)
    hideydecorations!(ax, label=false)
    xlims!(ax, 0.0,0.15)
    ...
    ax = Axis(g[5][1,1], xticks=4.5:0.5:6.5, xlabel=L"\beta \text{ FBB}", ylabelrotation=2pi, xlabelsize=50, ylabelpadding=20)
    hidespines!(ax, :l, :t, :r)
    hideydecorations!(ax, label=false)
    hist!(vec(Array(pst[Symbol("β_fbb")])), bins=15, color=alphacolor(colors[1], 1.0), strokecolor=:white, strokewidth=1)
    xlims!(ax, 4.,7.)
    ax = Axis(g[5][1,2], xticks=4.5:0.5:6.5, xlabel=L"\beta \text{ FBP}", ylabelrotation=2pi, xlabelsize=50, ylabelpadding=20)
    hidespines!(ax, :l, :t, :r)
    hideydecorations!(ax, label=false)
    ...
    ax = Axis(g[4][1,1], xticks=0.0:0.05:0.25,  xlabel=L"1 / yr", xlabelsize=25,ylabel=L"\eta", ylabelrotation=2pi, ylabelsize=50, ylabelpadding=20)
    hidespines!(ax, :l, :t, :r)
    hideydecorations!(ax, label=false)
    xlims!(ax, 0.0,0.25)
...
begin
    ...
    ax = Axis(g[5][1,1], xticks=4.5:0.5:6.5, xlabel=L"\beta", ylabelrotation=2pi, xlabelsize=50, ylabelpadding=20)
    hidespines!(ax, :l, :t, :r)
    hideydecorations!(ax, label=false)
